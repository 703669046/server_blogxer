...
{
    //无需登录的请求数组
    protected $no_login = ['login/captcha', 'login/login','user/save','user/captcha','user/index'];
     ...
     */
    protected function response($code=200, $msg='success', $data=[],$success)
    {
        $res = [
            'code' => $code,
            'msg' => $msg,
     ...
     * @param string $msg 错误信息
     */
    protected function ok($data=[], $code=200, $msg='success',$success=true)
    {
        $this->response($code, $msg, $data,$success);
    }
     ...
     * @param array $data 返回数据
     */
    protected function fail($msg, $code=500, $data=[],$success=false)
    {
        $this->response($code, $msg, $data,$success);
    }
